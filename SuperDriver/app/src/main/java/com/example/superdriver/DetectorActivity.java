                    ...
                    public void run() {
                        ...
                        for (final Classifier.Recognition result : results) {
                            ...
                            if (location != null && result.getConfidence() >= minimumConfidence) {
                                ...
                                Log.e("Like", location.top + " " + location.left + " " + location.right + " " + location.bottom + " " + result.getConfidence() + " " +
                                        result.getTitle());
                                cropToFrameTransform.mapRect(location);
                                Log.e("Like2", location.top + " " + location.left + " " + location.right + " " + location.bottom + " " + result.getConfidence() + " " +
                                        result.getTitle());
